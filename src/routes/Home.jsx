...
const Home = ({ currentSectors, setCurrentSectors }) => {
    return (<>
        <div className="parallax section homehero  d-none image-bg" data-stellar-background-ratio="0.5"  >
                    ...
                    <div className="col-md-7 home-message-height">
                        <div className="home-message">
                            ...
                            {currentSectors !== "All" && <div className="svg-wrapper" style={{marginTop:"-80px"}}>
                                ...
                                {currentSectors !== "Private" && <div className="svg-wrapper"  style={ {marginTop:currentSectors !== "All"  && "-80px"}}>
                                    <div className="ttext">
